...

{
    ...
    strncpy(tabMot2,tabPhrase+tabsep[0]+1,tabsep[1]-tabsep[0]-1);
    strncpy(tabMot3,tabPhrase+tabsep[1]+1,tabsep[2]-tabsep[1]-1);
    strncpy(tabMot4,tabPhrase+tabsep[2]+1,tabsep[3]-tabsep[2]-1);
    strncpy(tabMot5,tabPhrase+tabsep[3]+1,strlen(tabPhrase)-tabsep[4]-1);
